...
class ShipStation
{
    ...
    /**
     * ----------------------------------------------------
     *  getFulfillments($filters)
     * ----------------------------------------------------
     *
     * Get a list of all fulfillments on ShipStation matching the filter.
     *
     * @param    Array $filters
     *
     * @return   Array $fulfillments
     */

    public function getFulfillments($filters)
    {
